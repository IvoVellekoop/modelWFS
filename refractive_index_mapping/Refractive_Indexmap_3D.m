...
figure(2);
subplot(1,2,1); imagesc(squeeze(TPM_3D(end/2,:,:))'); colormap(hot); axis image; axis off;
subplot(1,2,2); imagesc(squeeze(n_sample(end/2,:,:))'); colormap(parula); axis image; axis off;
